...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_doesNotDeliverResultAfterSUTInstanceHasBenDeallocated() {
    ...
    private func makeSUT(url: URL = URL(string: "https://test-url.com")!, file: StaticString = #file, line: UInt = #line) -> (RemoteFeedLoader, HTTPClientSpy) {
        let client = HTTPClientSpy()
    ...
    private func testForMemoryLeaks(_ instance: AnyObject, file: StaticString = #file, line: UInt = #line) {
